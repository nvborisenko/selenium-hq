// <copyright file="V135Log.cs" company="Selenium Committers">
...
using OpenQA.Selenium.DevTools.V135.Log;
using System;
...
/// <summary>
/// Class containing the browser's log as referenced by version 135 of the DevTools Protocol.
/// </summary>
public class V135Log : DevTools.Log
{
    private LogAdapter adapter;

    /// <summary>
    /// Initializes a new instance of the <see cref="V135Log"/> class.
    /// </summary>
    /// <param name="adapter">The adapter for the Log domain.</param>
    /// <exception cref="ArgumentNullException">If <paramref name="adapter"/> is <see langword="null"/>.</exception>
    public V135Log(LogAdapter adapter)
    {
