// <copyright file="V131Domains.cs" company="Selenium Committers">
...
namespace OpenQA.Selenium.DevTools.V131
{
    ...
    public class V131Domains : DevToolsDomains
    {
        ...
        /// </summary>
        public static int DevToolsVersion => 131;
        ...
        /// </summary>
        public override DevTools.Network Network => new V131Network(domains.Network, domains.Fetch);

        /// <summary>
        /// Gets the object used for manipulating the browser's JavaScript execution.
        /// </summary>
        public override JavaScript JavaScript => new V131JavaScript(domains.Runtime, domains.Page);

        /// <summary>
        /// Gets the object used for manipulating DevTools Protocol targets.
        /// </summary>
        public override DevTools.Target Target => new V131Target(domains.Target);
